...
class SectiontimeHelper
{
  ...
  public static function formatsectiontimes($sectiontimes){
        ...
        foreach ($sectiontimes as $sectiontime) {
            $sectiontime->weekday = $days[$sectiontime->weekday];
            $sectiontime->starttime = $times[$sectiontime->starttime];
            $sectiontime->endtime = $times[$sectiontime->endtime];
            $sectiontime->classtype = $classtypes[$sectiontime->classtype];
        }
        return $sectiontimes;
  }
}